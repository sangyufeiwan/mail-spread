...
public class AddSubscribersByInfo2  implements java.io.Serializable {
    ...
    /**
     * Gets the loginEmail value for this AddSubscribersByInfo2.
     *
     * @return loginEmail
     */
    ...
    /**
     * Sets the loginEmail value for this AddSubscribersByInfo2.
     *
     * @param loginEmail
     */
    ...
    /**
     * Gets the password value for this AddSubscribersByInfo2.
     *
     * @return password
     */
    ...
    /**
     * Sets the password value for this AddSubscribersByInfo2.
     *
     * @param password
     */
    ...
    /**
     * Gets the subscriberArgs value for this AddSubscribersByInfo2.
     *
    ...
    /**
     * Sets the subscriberArgs value for this AddSubscribersByInfo2.
     *
    ...
    /**
     * Gets the subscription value for this AddSubscribersByInfo2.
     *
     * @return subscription
     */
    ...
    /**
     * Sets the subscription value for this AddSubscribersByInfo2.
     *
     * @param subscription
     */
    ...
    /**
     * Gets the optInType value for this AddSubscribersByInfo2.
     *
     * @return optInType
     */
    ...
    /**
     * Sets the optInType value for this AddSubscribersByInfo2.
     *
     * @param optInType
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof AddSubscribersByInfo2)) return false;
        AddSubscribersByInfo2 other = (AddSubscribersByInfo2) obj;
        ...
        _equals = true &&
            ...
            ((this.subscriberArgs==null && other.getSubscriberArgs()==null) ||
             (this.subscriberArgs!=null &&
              java.util.Arrays.equals(this.subscriberArgs, other.getSubscriberArgs()))) &&
    ...
    public synchronized int hashCode() {
        ...
        if (getSubscriberArgs() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getSubscriberArgs());
                 i++) {
                Object obj = java.lang.reflect.Array.get(getSubscriberArgs(), i);
                if (obj != null &&
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AddSubscribersByInfo2.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.reasonablespread.com/", ">addSubscribersByInfo2"));
        ...
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("http://service.reasonablespread.com/", "Subscriber"));
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
