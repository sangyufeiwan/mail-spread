...
public class CreateCampaign2  implements java.io.Serializable {
    ...
    private com.reasonablespread.CampaignCreatives[] campaignCreatives;
    ...
    public CreateCampaign2(
           ...
           String password,
           String campaignName,
           com.reasonablespread.CampaignCreatives[] campaignCreatives,
           String[] category,
           int interval,
     ...
     */
    public com.reasonablespread.CampaignCreatives[] getCampaignCreatives() {
        return campaignCreatives;
    }
     ...
     */
    public void setCampaignCreatives(com.reasonablespread.CampaignCreatives[] campaignCreatives) {
        this.campaignCreatives = campaignCreatives;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getCampaignCreatives() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getCampaignCreatives(), i);
                if (obj != null &&
