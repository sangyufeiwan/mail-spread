...
public class CreateCampaignSerialize  implements java.io.Serializable {
    private String loginEmail;

    private String password;

    private String strcampaignArgs;

    private String[] category;

    private int interval;

    public CreateCampaignSerialize() {
    }

    public CreateCampaignSerialize(
           String loginEmail,
           String password,
           String strcampaignArgs,
           String[] category,
           int interval) {
    ...
    /**
     * Gets the loginEmail value for this CreateCampaignSerialize.
     *
     * @return loginEmail
     */
    ...
    /**
     * Sets the loginEmail value for this CreateCampaignSerialize.
     *
     * @param loginEmail
     */
    ...
    /**
     * Gets the password value for this CreateCampaignSerialize.
     *
     * @return password
     */
    ...
    /**
     * Sets the password value for this CreateCampaignSerialize.
     *
     * @param password
     */
    ...
    /**
     * Gets the strcampaignArgs value for this CreateCampaignSerialize.
     *
     * @return strcampaignArgs
     */
    public String getStrcampaignArgs() {
        return strcampaignArgs;
    }


    /**
     * Sets the strcampaignArgs value for this CreateCampaignSerialize.
     *
     * @param strcampaignArgs
     */
    public void setStrcampaignArgs(String strcampaignArgs) {
        this.strcampaignArgs = strcampaignArgs;
    }


    /**
     * Gets the category value for this CreateCampaignSerialize.
     *
     * @return category
     */
    ...
    /**
     * Sets the category value for this CreateCampaignSerialize.
     *
     * @param category
     */
    ...
    /**
     * Gets the interval value for this CreateCampaignSerialize.
     *
     * @return interval
     */
    ...
    /**
     * Sets the interval value for this CreateCampaignSerialize.
     *
     * @param interval
     */
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof CreateCampaignSerialize)) return false;
        CreateCampaignSerialize other = (CreateCampaignSerialize) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CreateCampaignSerialize.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://service.reasonablespread.com/", ">createCampaignSerialize"));
